        ...
        <form className="form-container flex-col w-full">
          <div className="ml-12 mt-6 mb-6">
            ...
            <div className="flex flex-row ml-12 mt-12">
                <button className="bg-airnav-blue text-white p-4 w-full rounded-md hover:bg-transparent hover:text-AirNav hover:border-AirNav hover:border transition duration-300 ease-in-out border">
                Simpan Data
                </button>
            </div>
        </form>
